...
REGISTER_COINS(
    ...
    #if defined(HAVE_COIN_RAIBLOCKSONE)
    COIN(LIBN_COIN_TYPE_RAIBLOCKSONE, {
        .coinName = "RaiblocksOne",
        #if defined(TARGET_BLUE)
        .coinBadge = &C_blue_badge_raiblocksone,
        #else
        .coinBadge = &C_nanos_badge_raiblocksone,
        #endif
        .bip32Prefix = { HARDENED(44), HARDENED(165) },
        .addressPrimaryPrefix = "xro_",
        .addressSecondaryPrefix = "xro_",
        .addressDefaultPrefix = LIBN_PRIMARY_PREFIX,
        .defaultUnit = "RAIBLOCKSONE",
        .defaultUnitScale = 30, // 1 RAIBLOCKSONE = 10^30 raw
        #if defined(TARGET_BLUE)
        .colorBackground = 0xF9F9F9,
        .colorForeground = 0x000000,
        .colorAltBackground = 0x4A90E2,
        ...
        .colorConfirmOverForeground = 0xFFFFFF,
        .iconToggleOff = &C_blue_icon_toggle_off,
        .iconToggleOn = &C_blue_icon_toggle_on_raiblocksone,
        #endif // TARGET_BLUE
    })
    #endif
