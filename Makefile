...
# RaiblocksOne coin config
RAIBLOCKSONE_APP_NAME = "RaiblocksOne"
RAIBLOCKSONE_PATH_PARAM = --path "44'/165'"
RAIBLOCKSONE_COIN_TYPE = LIBN_COIN_TYPE_RAIBLOCKSONE
ALL_PATH_PARAMS += $(RAIBLOCKSONE_PATH_PARAM)
...
DEFINES += HAVE_COIN_RAIBLOCKSONE
...
else ifeq ($(COIN),raiblocksone)
APPNAME = $(RAIBLOCKSONE_APP_NAME)
APP_LOAD_PARAMS += $(APP_LOAD_FLAGS) $(RAIBLOCKSONE_PATH_PARAM)
DEFINES += HAVE_COIN_RAIBLOCKSONE
DEFINES += DEFAULT_COIN_TYPE=$(RAIBLOCKSONE_COIN_TYPE)
...
$(error Unsupported COIN - use nano, raiblocksone, banano, nos)
endif
